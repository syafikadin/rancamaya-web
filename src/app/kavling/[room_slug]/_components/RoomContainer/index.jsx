...
const room_dummy = {
  ...
  description:
    "Rancamaya Golf Estate, relish in this great family vacation spot; a beautiful unit in a beautiful development. Enjoy mountain views from your large second floor balcony.",
  price: 3800000,
  capacity: 6,
  bedroom: 3,
  bathroom: 2,
...
const room_images_dummy = [
  { img_path: "kavling_kertanegara.jpg" },
  { img_path: "kavling_kertanegara_drone.jpg" },
  { img_path: "kavling_salvador.jpg" },
];
